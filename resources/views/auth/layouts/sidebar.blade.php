...
<head>
    ...
    <link href="/bootstrap5_1/css/sidebars.css" rel="stylesheet">
</head>
<body>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <svg id="categories" viewBox="0 0 16 16">
        <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1H4z"/>
    </svg>
    <svg id="tag" viewBox="0 0 16 16">
...
<div class="position-fixed" style="padding: 10px">
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-white" style="width: 300px;" >
        <a href="{{ route('index') }}" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
            ...
            <span class="fs-4">Вернуться на сайт</span>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="{{ route('products.index') }}" class="nav-link link-dark @activeadminpanel('products.index')">
                    <svg class="bi me-2" width="20" height="20"><use xlink:href="#grid"/></svg>
                    <span class="fs-5">Товары</span>
                </a>
            </li>
            <li>
                <a href="{{ route('properties.index') }}" class="nav-link link-dark @activeadminpanel('properties.index')">
                    <svg class="bi me-2" width="20" height="20"><use xlink:href="#tag"/></svg>
                    <span class="fs-5">Свойства</span>
                </a>
            </li>
            <li>
                <a href="#" class="nav-link link-dark disabled @activeadminpanel('#')">
                    <svg class="bi me-2" width="20" height="20"><use xlink:href="#people-circle"/></svg>
        ...
        @auth
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                    @admin
                    <img src="https://avatars.githubusercontent.com/u/32570816?v=4" alt="" width="32" height="32"
                         class="rounded-circle me-2">
                    <span class="fs-6">{{\Illuminate\Support\Facades\Auth::user()->name}}</span>
                    @else
                        <img
                            src="https://cdn-icons.flaticon.com/png/512/3024/premium/3024605.png?token=exp=1648552228~hmac=0e8f582fd80b04da8b3dc2b7ad9eae05"
                            alt="" width="32" height="32"
                            class="rounded-circle me-2">
                        <strong><span class="fs-6">{{\Illuminate\Support\Facades\Auth::user()->name}}</span></strong>
                        @endadmin
                </a>
...
<script src="/bootstrap5_1/js/sidebars.js"></script>
</body>
</html>
